...
$orderDetails["appId"] = "CF110673C8ES0VRG1A0QGEN8IQ30";
...
function generateSignature($postData){
  $secretKey = "5e10b0cfa820a74de51cd93843b1bf0b1aeecaa3";
 ksort($postData);
 $signatureData = "";
...
?>
 <form id="redirectForm" method="post" action="https://www.cashfree.com/checkout/post/submit">
  <!-- <form id="redirectForm" method="post" action="https://sandbox.cashfree.com/pg"> -->
